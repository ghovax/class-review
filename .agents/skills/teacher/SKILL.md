...
## name: teacher description: Generate, resume, and export a durable lesson with the teacher Python library. Use for long-running lesson generation from audio, timestamped transcripts, and optional PDFs.
