...
| --- | --- | --- |
| Scope and authority | What the lecture claims, assumes, demonstrates, leaves open, or explicitly defers | What belongs in the lesson and what must remain outside it |
| Learner objective | The capability or understanding the learner should gain | The purpose of each chapter and concept |
| Progression | Whether the material introduces, deepens, applies, reviews, or constrains an idea | What must be established first and what counts as genuinely new |
| Core substance | Definitions, mechanisms, procedures, examples, comparisons, and conclusions | Which passages belong together and which require their own unit |
| Evidence and provenance | Observations, measurements, quotations, reference pages, or demonstrations supporting a claim | Where to preserve evidence and place citations |
| Boundary and non-repetition | Terms, values, mechanisms, examples, and conclusions already established | What later units may reference but must not re-teach |
| Uncertainty and limitations | Ambiguity, exceptions, source conflict, missing evidence, or unresolved questions | How to qualify claims without inventing certainty |
| Presentation shape | Connected reasoning, parallel items, comparisons, equations, procedures, or visual relationships | Whether to use prose, a list, a table, an equation, or a visual |
