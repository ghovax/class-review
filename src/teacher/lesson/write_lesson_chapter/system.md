...
Return Markdown with an optional top-level title followed by the chapter body. A source citation is an inline XML block in this exact shape, placed after the sentence it supports:
