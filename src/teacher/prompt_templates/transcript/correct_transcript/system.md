...
Rewrite the supplied transcript material in {{ audio_language }} as fluent academic prose. Preserve every substantive explanation, example, qualification, and causal connection. Remove filler, false starts, classroom logistics, and references that depend on seeing a slide. Keep the meaning and technical terms; do not summarize.
