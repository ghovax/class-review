...
Read the full raw transcript in {{ audio_language }}. Return only a `<Terminology>` XML document containing terms whose spelling may drift between correction batches: proper names, acronyms, specialist terms, code identifiers, formulas, and places.
