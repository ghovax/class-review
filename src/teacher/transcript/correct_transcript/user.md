...
| Field | Value | | --- | --- | | Language | {{ language }} | | Source time range | {{
start_seconds }}s to {{ end_seconds }}s |
...
Keep all substantive reasoning, use source timestamps, and write prose rather than
notation or symbol chains.
